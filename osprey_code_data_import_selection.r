...
st_df <- osprey%>%
          ...
          mutate(stop_id = dplyr::case_when(
                    ...
                    ID == "A7" & time >= "2017-05-10 24:00:00" & time <= "2017-05-17 06:00:00" ~ "A7_stop4",
                    ID == "A7" & time >= "2017-05-21 14:00:00" & time <= "2017-05-26 08:30:00" ~ "A7_stop5",
                    ID == "A7" & time >= "2017-05-28 14:00:00" & time <= "2017-06-11 06:00:00" ~ "A7_stop6",
                    ID == "A7" & time >= "2017-06-11 20:00:00" & time <= "2017-07-27 06:00:00" ~ "A7_stop7",
                    ID == "A7" & time >= "2017-07-28 00:00:00" ~ "A7_end",
                    ...
                    ID == "CBK" & time >= "2014-04-11 20:00:00" ~ "CBK_end",
                    ...
                    ID == "E7" & time >= "2016-05-16 19:30:00" & time <= "2016-05-20 12:00:00" ~ "E7_stop9",
                    ...
                    ID == "IBH" & time >= "2022-04-11 11:00:00" & time <= "2022-04-20 08:30:00" ~ "IBH_stop3",
                    ...
                    ID == "IFP" & time >= "2022-07-23 21:00:00" & time <= "2022-07-26 06:00:00" ~ "IFP_stop1",
...
sttraj_df <- st_lt%>%
          ...
          mutate(doy = yday(date),
                    ...
                    time = date,
                    ID = id,
                    stop_id = dplyr::case_when(ID == 'A7' & time <= "2015-08-14 09:00:00"  ~ "A7_nest",
                    ID == "A7" & time >= "2015-08-17 20:00:00" & time <= "2017-02-20 06:00:00" ~ "A7_wintering1",
                    ID == "A7" & time >= "2017-03-01 14:00:00" & time <= "2017-03-17 06:00:00" ~ "A7_stop1",
                    ID == "A7" & time >= "2017-04-15 07:00:00" & time <= "2017-04-17 06:00:00" ~ "A7_stop2",
                    ID == "A7" & time >= "2017-04-20 20:00:00" & time <= "2017-04-28 06:00:00" ~ "A7_stop3",
