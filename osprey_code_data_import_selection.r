...
nd_df <- nd_df%>%
          filter(
           ...
           ID == "A7" & time >= "2017-05-23 06:00:00" & time <= "2017-05-23 14:00:00" |
...
st_df <- osprey%>%
          filter(ID == "A7" & time <= "2015-08-14 08:00:00" |
                    ID == "A7" & time >= "2015-08-18 09:00:00" & time <= "2017-02-20 06:00:00" |
                    ID == "A7" & time >= "2017-03-01 12:00:00" & time <= "2017-03-17 06:00:00" |
                    ID == "A7" & time >= "2017-04-14 18:00:00" & time <= "2017-04-17 06:00:00" |
                    ID == "A7" & time >= "2017-04-20 18:00:00" & time <= "2017-04-28 06:00:00" |
                    ID == "A7" & time >= "2017-05-10 12:00:00" & time <= "2017-05-14 08:00:00" |
                    ID == "A7" & time >= "2017-05-21 12:00:00" & time <= "2017-05-23 06:00:00" |
                    ID == "A7" & time >= "2017-05-23 14:00:00" & time <= "2017-05-26 08:00:00" |
                    ID == "A7" & time >= "2017-05-28 18:00:00" & time <= "2017-06-06 08:00:00" |
                    ID == "A7" & time >= "2017-06-06 12:00:00" & time <= "2017-06-11 06:00:00" |
                    ID == "A7" & time >= "2017-06-12 12:00:00" & time <= "2017-07-27 06:00:00" |
                    ID == "A7" & time >= "2017-07-27 18:00:00" |
                    ID == "Antares" & time <= "2015-08-15 11:00:00" |
                    ID == "Antares" & time >= "2015-08-18 16:30:00" & time <= "2015-09-08 09:30:00"  |
                    ID == "Antares" & time >= "2015-09-08 16:30:00" & time <= "2015-09-13 08:00:00"  |
                    ID == "Antares" & time >= "2015-09-13 12:00:00" & time <= "2016-04-04 00:00:00"  |
                    ID == "Antares" & time >= "2016-04-05 15:00:00" & time <= "2016-04-09 08:00:00"  |
                    ID == "Antares" & time >= "2016-04-10 14:00:00" & time <= "2016-04-19 10:00:00"  |
                    ID == "Antares" & time >= "2016-04-22 10:00:00" & time <= "2016-05-05 06:00:00"  |
                    ID == "Antares" & time >= "2016-05-06 06:00:00" & time <= "2016-05-14 12:00:00"  |
                    ID == "Antares" & time >= "2016-05-17 15:00:00" & time <= "2016-06-10 07:00:00"  |
                    ID == "Antares" & time >= "2016-06-12 15:00:00" |
                    ID == "CAM" & time <= "2016-04-14 07:00:00" |
                    ID == "CAM" & time >= "2016-04-15 11:00:00" & time <= "2016-04-19 10:00:00" |
                    ID == "CAM" & time >= "2016-04-19 17:00:00" & time <= "2016-05-03 07:00:00" |
                    ID == "CAM" & time >= "2016-05-06 15:00:00" & time <= "2016-05-20 04:00:00" |
                    ID == "CAM" & time >= "2016-05-24 14:00:00" & time <= "2016-07-02 23:00:00" |
                    ID == "CAM" & time >= "2016-07-06 18:00:00" |
                    ID == "CBK" & time >= "2013-08-15 06:00:00" |
                    ID == "CBK" & time >= "2013-08-21 08:00:00" & time <= "2014-03-20 08:00:00" |
                    ID == "CBK" & time >= "2014-03-21 10:00:00" & time <= "2014-04-08 07:30:00" |
                    ID == "CBK" & time >= "2014-04-12 08:00:00" |
                    ID == "CIV" & time <= "2014-08-16 09:00:00" |
                    ID == "CIV" & time >= "2014-08-21 18:00:00" & time <= "2014-09-11 11:00:00" |
                    ID == "CIV" & time >= "2014-09-13 13:00:00" & time <= "2014-10-21 08:00:00" |
                    ID == "CIV" & time >= "2014-10-21 18:00:00" & time <= "2015-03-21 02:00:00" |
                    ID == "CIV" & time >= "2015-03-21 20:00:00" & time <= "2015-06-04 06:00:00" |
                    ID == "CIV" & time >= "2015-06-16 12:00:00" & time <= "2015-06-20 00:00:00" |
                    ID == "CIV" & time >= "2015-06-22 14:00:00" & time <= "2015-08-13 06:00:00" |
                    ID == "CIV" & time >= "2015-08-13 20:00:00" & time <= "2015-11-22 00:01:00" |
                    ID == "CIV" & time >= "2015-11-25 16:01:00" & time <= "2016-03-29 06:00:00" |
                    ID == "CIV" & time >= "2016-03-31 18:00:00" & time <= "2016-04-15 06:00:00" |
                    ID == "CIV" & time >= "2016-04-18 20:00:00" & time <= "2016-10-28 08:00:00" |
                    ID == "CIV" & time >= "2016-10-29 18:00:00" |
                    ID == "E7" & time <= "2014-08-21 08:00:00" |
                    ID == "E7" & time >= "2014-08-27 11:00:00" & time <= "2016-03-10 06:00:00" |
                    ID == "E7" & time >= "2016-03-15 15:30:00" & time <= "2016-03-17 10:30:00" |
                    ID == "E7" & time >= "2016-03-22 13:30:00" & time <= "2016-03-24 07:30:00" |
                    ID == "E7" & time >= "2016-03-24 12:30:00" & time <= "2016-03-30 07:30:00" |
                    ID == "E7" & time >= "2016-04-10 10:00:00" & time <= "2016-04-12 10:30:00" |
                    ID == "E7" & time >= "2016-04-17 16:30:00" & time <= "2016-04-19 09:00:00" |
                    ID == "E7" & time >= "2016-04-22 14:30:00" & time <= "2016-04-24 11:30:00" |
                    ID == "E7" & time >= "2016-04-25 15:00:00" & time <= "2016-05-04 08:30:00" |
                    ID == "E7" & time >= "2016-05-07 12:30:00" & time <= "2016-05-12 10:00:00" |
                    ID == "E7" & time >= "2016-05-16 17:30:00" & time <= "2016-05-20 10:00:00" |
                    ID == "E7" & time >= "2016-05-21 16:00:00" & time <= "2016-05-23 07:30:00" |
                    ID == "E7" & time >= "2016-05-27 16:30:00" |
                    ID == "H7" & time <= "2013-08-04 08:00:00" |
                    ID == "H7" & time >= "2013-08-09 12:30:00" & time <= "2015-04-02 08:00:00" |
                    ID == "H7" & time >= "2015-04-06 11:00:00" & time <= "2015-04-07 17:00:00" |
                    ID == "H7" & time >= "2015-04-11 10:00:00" & time <= "2015-04-20 11:00:00" |
                    ID == "H7" & time >= "2015-04-30 13:30:00" & time <= "2015-05-03 05:30:00" |
                    ID == "H7" & time >= "2015-05-03 09:00:00" |
...
sttraj_df <- st_lt%>%
          ...
          mutate(doy = yday(date),
                    ...
                    stop_id = dplyr::case_when(
                              ...
                              ID == "A7" & time >= "2017-04-14 12:00:00" & time <= "2017-04-17 06:00:00" ~ "A7_stop2",
                              ...
                              ID == "A7" & time >= "2017-06-12 06:00:00" & time <= "2017-07-27 06:00:00" ~ "A7_stop8",
                              ID == "A7" & time >= "2017-07-27 12:00:00" ~ "A7_end",
