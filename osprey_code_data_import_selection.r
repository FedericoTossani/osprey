...
osprey_nd <- osprey%>%
         ...
         osprey_nd <- osprey_nd%>%
                  filter(ID == 'H7' & time >= '2013-08-04 09:30:00' & time <= '2013-08-09 15:30:00' | ID == 'H7' & time >= '2015-04-02 05:00:00'| #( & time <= '2015-05-10 00:00:00' )
                         ...
                         ID == 'IAD' & time >= '2016-08-20 09:00:00' & time <= '2016-08-25 11:00:00' | ID == 'IAD' & time >= '2018-03-28 08:00:00' & time <= '2018-06-12 14:00:00' | ID == 'IAD' & time >= '2019-03-04 10:00:00' & time <= '2019-05-07 15:00:00' | ID == 'IAD' & time >= '2019-07-08 09:00:00' & time <= '2019-07-15 18:00:00' |
