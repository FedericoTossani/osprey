...
osprey_nd <- osprey%>%
         ...
         osprey_nd <- osprey_nd%>%
                  filter(ID == 'H7' & time >= '2013-08-04 09:30:00' & time <= '2013-08-09 15:30:00' | ID == 'H7' & time >= '2015-04-02 05:00:00'| #( & time <= '2015-05-10 00:00:00' )
                         ...
                         ID == 'E7' & time >= '2014-08-16 08:30:00' & time <= '2014-08-27 13:00:00' | ID == 'E7' & time >= '2016-03-10 05:00:00' |
                         ID == 'A7' & time >= '2017-02-20 00:00:00' |
                         ID == 'IAD' & time >= '2016-08-20 09:00:00' & time <= '2016-08-25 11:00:00' | ID == 'IAD' & time >= '2018-03-28 08:00:00' & time <= '2018-06-12 14:00:00' | ID == 'IAD' & time >= '2018-12-15 00:00:00' & time <= '2018-12-20 15:00:00' | ID == 'IAD' & time >= '2019-03-04 10:00:00' & time <= '2019-04-01 17:00:00' | ID == 'IAD' & time >= '2019-04-14 20:00:00' & time <= '2019-05-07 15:00:00' | ID == 'IAD' & time >= '2019-07-08 09:00:00' & time <= '2019-07-15 18:00:00' |
                         ...
                         ID == 'IBH' & time >= '2020-08-07 07:00:00' & time <= '2020-08-15 15:00:00' | ID == 'IBH' & time >= '2022-04-09 06:00:00' |
                         ID == 'IBK' & time >= '2022-01-24 06:44:48' |
                         ID == 'IFP' & time >= '2022-07-23 06:00:00' & time <= '2022-08-15 00:00:00' | ID == 'IFP' & time > '2023-04-24 00:00:00' | # ( & time < '2023-04-30 04:00:00' | ID == "IFP" & time >= '2023-05-16 00:00:00' & time <= '2023-06-08 20:00:00' )
                         ID == 'ICZ' & time >= '2020-04-11 10:45:00' & time <= '2020-04-25 00:00:00' |
                         ID == 'CBK' & time >= '2013-08-15 00:00:00' & time <= '2013-08-21 12:00:00' |ID == 'CBK' & time >= '2014-03-20 04:30:00' & time <= '2014-03-22 10:30:00' | ID == 'CBK' & time >= '2014-04-08 06:30:00' & time <= '2014-04-12 11:00:00' |
...
osprey_nonb <- osprey%>%
                  filter(ID == 'H7' & time >= '2013-08-09 15:30:00' & time <= '2015-04-02 05:00:00'|
                         ID == 'CIV' & time <= "2014-08-16 06:00:00" | ID == 'CIV' & time >= "2014-10-22 12:00:00" & time <= '2015-06-04 03:00:00' | ID == 'CIV' & time >= '2015-11-26 24:00:00' & time <= '2016-03-29 00:01:00' | ID == 'CIV' & time >= '2016-10-29 18:00:00' | 
                         ID == 'E7' & time >= '2014-08-27 13:00:00' & time <= '2016-03-10 05:00:00' |
                         ID == 'A7' & time <= '2017-02-20 00:00:00' |
                         ID == 'IAD' & time >= '2016-08-25 11:00:00' & time <= '2018-03-28 08:00:00' | ID == 'IAD' & time >= '2018-06-12 14:00:00' & time <= '2018-12-15 00:00:00' | ID == 'IAD' & time >= '2018-12-20 15:00:00' & time <= '2019-03-04 10:00:00' | ID == 'IAD' & time >= '2019-05-07 15:00:00' & time <= '2019-07-08 09:00:00'| ID == 'IAD' & time >= '2019-07-15 18:00:00' |
                         ID == 'IBS' & time <= "2020-08-07 08:00:00" | ID == 'IBS' & time >= "2020-08-18 19:00:00" & time <= "2021-02-15 09:00:00" | ID == 'IBS' & time >= "2021-05-01 16:00:00" & time <= '2022-03-22 00:00:00' | ID == 'IBS' & time >= '2022-06-04 15:00:00' & time <= "2023-02-08 16:00:00" | ID == 'IBS' & time >= "2023-02-28 00:00:00" |
                         ID == 'IBH' & time <= '2022-04-09 06:00:00' |
                         ID == 'IBK' & time <= '2022-01-24 06:44:48' |
                         ID == 'IFP' & time < '2023-04-24 00:00:00' |
                         ID == 'ICZ' & time <= '2020-04-11 10:45:00' | ID == 'ICZ' & time >= '2020-04-25 00:00:00' |
                         ID == 'CBK' & time <= '2014-04-08 06:30:00' | ID == 'CBK' & time >= '2014-04-12 11:00:00' |
                         ID == 'IAB' & time <= '2019-05-05 06:00:00' | ID == 'IAB' & time >= '2019-06-10 14:00:00' & time <= '2020-03-16 00:00:00' |
                         ID == "CAM" & time <= "2016-04-14 06:00:00" | ID == "CAM" & time >= "2016-04-19 20:00:00" & time <= "2016-05-03 08:00:00" | ID == "CAM" & time >= "2016-05-06 18:00:00" & time <= "2016-05-20 05:00:00" | ID == "CAM" & time >= "2016-05-24 18:00:00" & time <= "2016-07-02 23:00:00" | ID == "CAM" & time >= "2016-07-06 20:00:00" |
                         ID == "IBI" & time <= "2017-07-21 05:00:00" | ID == "IBI" & time >= "2017-07-27 20:00:00" |
                         ID == "Antares" & time <= "2015-08-15 11:00:00" | ID == "Antares" & time >= "2015-08-18 19:00:00" & time <= "2015-09-08 10:30:00" | ID == "Antares" & time >= "2015-09-13 20:00:00" & time <= "2016-03-19 13:00:00" | ID == "Antares" & time >= "2016-06-28 18:00:00")%>%
