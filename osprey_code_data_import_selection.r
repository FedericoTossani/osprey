...
osprey_nd <- osprey%>%
         ...
         osprey_nd <- osprey_nd%>%
                  filter(ID == 'H7' & time >= '2013-08-04 09:30:00' & time <= '2013-08-09 15:30:00' |
                         ...
                         ID == 'CIV' & time >= "2014-08-16 06:00:00" & time <= "2014-10-22 12:00:00" |
                         ID == 'CIV' & time >= '2015-06-04 03:00:00' & time <= '2015-11-26 24:00:00' |
                         ID == 'CIV' & time >= '2016-03-29 00:01:00' & time <= '2016-10-29 18:00:00' | 
...
osprey_nonb <- osprey%>%
                  filter(ID == 'H7' & time >= '2013-08-09 15:30:00' & time <= '2015-04-02 05:00:00'|
                         ...
                         ID == 'A7' & time <= '2017-02-20 00:00:00' |
                         ID == 'IAD' & time >= '2016-08-25 11:00:00' & time <= '2018-03-28 08:00:00' |
                         ID == 'IAD' & time >= '2018-06-12 14:00:00' & time <= '2018-12-15 00:00:00' |
                         ID == 'IAD' & time >= '2018-12-20 15:00:00' & time <= '2019-03-04 10:00:00' |
                         ID == 'IAD' & time >= '2019-05-07 15:00:00' & time <= '2019-07-08 09:00:00'|
