...
nd_df <- nd_df%>%
          ...
          ID == "E7" & time >= "2016-05-20 07:00:00" & time <= "2016-05-21 18:30:00" |
...
nd_df <- nd_df%>%
          ...
          track_id = dplyr::case_when(
                              ...
                              ID == "E7" & time >= "2016-05-20 07:00:00" & time <= "2016-05-21 18:30:00" ~ "E7_nd3c",
...
st_df <- osprey%>%
          filter(ID == 'A7' & time <= "2015-08-14 09:00:00" |
                    ...
                    ID == "E7" & time >= "2016-05-16 19:30:00" & time <= "2016-05-20 07:00:00" |
