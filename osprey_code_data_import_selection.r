...
nd_df <- nd_df%>%
          ...
          track_id = dplyr::case_when(
                              ...
                              ID == "A7" & time >= "2017-05-23 06:00:00" & time <= "2017-05-23 16:00:00" ~ "A7_nd4c",
                              ID == "A7" & time >= "2017-05-26 08:30:00" & time <= "2017-05-28 14:00:00" ~ "A7_nd4d",
...
st_df <- osprey%>%
          ...
          mutate(stop_id = dplyr::case_when(
                    ...
                    ID == "A7" & time >= "2017-05-21 14:00:00" & time <= "2017-05-23 06:00:00" ~ "A7_stop5",
                    ID == "A7" & time >= "2017-05-23 16:00:00" & time <= "2017-05-26 08:30:00" ~ "A7_stop6",
                    ID == "A7" & time >= "2017-05-28 14:00:00" & time <= "2017-06-11 06:00:00" ~ "A7_stop7",
                    ID == "A7" & time >= "2017-06-11 20:00:00" & time <= "2017-07-27 06:00:00" ~ "A7_stop8",
