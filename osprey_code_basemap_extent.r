...
stopoverPA <- vect("C:/Tesi/R/osprey/data/PA_32632.shp")
allPA <- vect("C:/Tesi/data/Natura2000/natura2000_osprey_4326.shp")
...
# "CBK"     
# First let's crop
CBK_ext <- ext(c(7.8000, 11.0000, 38.5000, 43.2500))
