...
nd_df <- nd_lt%>%
          ...
          burst = dplyr::case_when(
                    ...
                    id == "Antares" & date >= "2016-04-04 00:00:00" & date <= "2016-04-05 15:00:00" |
                    id == "Antares" & date >= "2016-04-09 08:00:00" & date <= "2016-04-10 14:00:00" ~ "Antares_nd3",
                    ...
                    id == 'CAM' & date >= "2016-04-14 07:00:00" & date <= "2016-04-15 11:00:00" |
                    id == 'CAM' & date >= "2016-04-19 10:00:00" & date <= "2016-04-19 17:00:00" ~ "CAM_nd1",
